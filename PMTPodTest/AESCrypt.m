...
+ (NSData *) EncryptString:(NSString *)plainSourceStringToEncrypt withKey:(NSString *) key {
	AESCrypt *crypto = [[AESCrypt alloc] init];
	...
	//NSData *encryptedData = [crypto encrypt:_secretData key:[crypto md5data:key] padding:&padding];		
	NSData *encryptedData = [crypto encrypt:_secretData key:[key dataUsingEncoding:NSUTF8StringEncoding] padding:&padding];
